...
// Выведите весь массив в консоль
{
  ...
  // fruits.splice(1, 1, 'персик').splice(3, 1, 'банан'); -- а почему так не работает?
...
// Функция должна возвращать общую стоимость гравироки всего предложения.
{
  ...
  ); // -- КОСЫЕ КАВЫЧКИ У АРГУМЕНТА!!!!!!!!!!

  // calculateEngravingPrice('Hi! I`m JavaScript! Nice to meet you!', 10); // 70
  // calculateEngravingPrice(`Вы заказали дронов на сумму 11 кредитов.`, 15); // 105 -- КОСЫЕ КАВЫЧКИ У АРГУМЕНТА!!!!!!!!!!
}
...
// Возвращает результирующую строку.
{
  function makeStringFromArray(array, delimeter) {
    // let string; // -- не нужная переменная!!!!
    // Пиши код ниже этой строки
